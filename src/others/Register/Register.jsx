...
const Register = () => {
   ...
   <section className='my-container my-10 '>
         <form onSubmit={handleRegister} className='mx-5 rounded-xl shadow-xl  md:w-1/2 md:mx-auto px-5 py-10 border-2 border-[#82B440]'>
            <h4 className='text-[#82B440] text-2xl font-bold mb-5 text-center'>Register Form</h4>
        <div className="form-control">
            <label className="label">
                <span className="label-text">Your Name</span>
            </label>
            <label className="">
                <input type="text" name='name' placeholder='Saiful Islam' className='input input-bordered w-full max-w-xs"' required/>
            </label>
        </div>
        <div className="form-control">
            <label className="label">
            ...
            <label className="">
                <input type="text" name='photo' placeholder='photo.jpg' className='input input-bordered w-full max-w-xs"' required/>
            </label>
        </div>
        <div className="form-control">
            <label className="label">
        ...
        <p className='text-center mt-2'>Already have an account? <Link to='/login' className='text-[#82B440] underline'>login</Link></p>
    </form>
   </section>
    );
};
